...
<div class="container-fluid wrapper-header-contato p-0">
	...
	<section class="container-fluid wrapper-contato">
		<div class="container wrapper-inner contato">
			<div class="row contato-intro">
				<div class="contato-intro-item contato-intro-text col-12 col-md-6 d-flex justify-content-center align-items-start flex-column">
					<span class="contato-intro-text-desc"><?php echo $subtitulo_contato; ?></span>
					<span class="contato-intro-text-instrucoes"><?php echo $instrucoes_contato; ?></span>
				</div>
				<div class="contato-intro-item contato-intro-contatos col-12 col-md-6 d-flex justify-content-center align-items-center">
					<div class="row d-flex justify-content-center align-items-center w-100">
						<div class="contato-intro-contatos-img col-2 text-right">
							<img src="<?php echo $icone_contato_tel; ?>" alt="<?php echo $alt_icone_contato_tel; ?>">
						</div>
						<div class="contato-intro-contatos-tels col-5">
							<p class="contato-intro-contatos-tels-text"><?php echo $titulo_tel_pabx; ?></p>
							<a class="contato-intro-contatos-tels-tel" onclick="dataLayer.push({'event': 'telefone_pabx'})" href="tel:<?php echo $num_tel_pabx; ?>"><?php echo $txt_tel_pabx; ?></a>
						</div>
						<div class="contato-intro-contatos-tels col-5">
							<p class="contato-intro-contatos-tels-text"><?php echo $titulo_tel_vendas; ?></p>
							<a class="contato-intro-contatos-tels-tel" onclick="dataLayer.push({'event': 'telefone_vendas'})" href="tel:<?php echo $num_tel_vendas; ?>"><?php echo $txt_tel_vendas; ?></a>
						</div>
					</div>
				</div>
			</div>

			<div class="row contato-box">
				<?php
					foreach($contatos as $contato){
						...
						echo '<div class="col-12 col-md-6">
									<a class="contato-box-item" ' . $onclickCheck . ' href="' . $url_contato . '"' . $contato_target . '>
										<div class="contato-box-item-icon d-flex justify-content-center align-items-center">
											<img src="' . $contato["icone"] . '" alt="' . $contato["alt"] . '">
										</div>
										<div class="contato-box-item-info">
											<h3 class="contato-box-item-info-titulo">' . $contato["titulo"] . '</h3>
											<p class="contato-box-item-info-desc">' . $contato["desc"] . '</p>
										</div>
									</a>
								</div>';
					}
