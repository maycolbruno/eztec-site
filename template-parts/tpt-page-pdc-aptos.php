<?php
/*
 * Template Name: Parque da Cidade - Apartamentos
...
?>
<div class="container-fluid wrapper-imovel pdc pdc-aptos p-0">
	...
	<div id="primary" class="content-area">
		<main id="main" class="site-main">
						...
						<div class="wrapper-videopreview">
							<div class="video-preview-txt-container">
								<div class="wrap-titulo-banner-pdc">
									<h1 class="videopreview-titulo pdc-aptos"><?php echo $tpt_pdc_banner_titulo; ?><div class="detalhe-titulo-pdc"></div></h1>
								</div>
			...
			$tpt_pdc_apresentacao_show = get_field("tpt_pdc_show_apresentacao");
			$tpt_pdc_apresentacao_titulo = get_field("tpt_pdc_apresentacao_titulo");
			$tpt_pdc_apresentacao_chamada = get_field("tpt_pdc_apresentacao_chamada");
			$tpt_pdc_apresentacao_desc = get_field("tpt_pdc_apresentacao_desc");
			$tpt_pdc_apresentacao_citacao = get_field("tpt_pdc_apresentacao_citacao");
			$tpt_pdc_apresentacao_box = get_field("tpt_pdc_apresentacao_box");
			$tpt_pdc_apresentacao_img = get_field("tpt_pdc_apresentacao_img");
			$tpt_pdc_apresentacao_citacao_img = get_field("tpt_pdc_apresentacao_citacao_img");
			$tpt_pdc_apresentacao_img_extendida = get_field("tpt_pdc_apresentacao_img_extendida");
			?>

			<div class="wrapper-geral wrapper-geral-pdc-apresentacao">
				<div class="wrapper-inner-pdc-apresentacao-apto">
							...
							<div class="sec-apresentacao-left col-xl-7 col-lg-7 col-12">
								<div class="wrap-apresentacao-left-txt">
									<div class="apresentacao-info">
										<h2 class="apresentacao-info-titulo"><?php echo $tpt_pdc_apresentacao_titulo; ?></h2>
										<div class="apresentacao-divisor-pdc"></div>
										<p class="apresentacao-info-chamada"><?php echo $tpt_pdc_apresentacao_chamada; ?></p>
										<p class="apresentacao-info-desc"><?php echo $tpt_pdc_apresentacao_desc; ?></p>
									</div>
								</div>
								<div class="wrap-img-apresentacao-pdc">
									<img class="img-apresentacao-pdc img-fluid" src="<?php echo $tpt_pdc_apresentacao_citacao_img; ?>" alt="<?php echo $tpt_pdc_apresentacao_titulo; ?>">
								</div>
							</div>
							<div class="sec-apresentacao-right col-xl-5 col-lg-5 col-12">
								<img class="img-citacao img-fluid" src="<?php echo $tpt_pdc_apresentacao_img; ?>" alt="<?php echo $tpt_pdc_apresentacao_titulo; ?>">
								<div class="wrap-apresentacao-citacao">
									<p class="apresentacao-citacao"><?php echo $tpt_pdc_apresentacao_citacao; ?></p>
								</div>
								<div class="wrapper-box-produto-pdc-aptos">
									<?php echo $tpt_pdc_apresentacao_box; ?>
								</div>
							</div>
						</div>
					</div>
			...
			<div class="wrapper-geral">
				<img class="img-extendida-pdc img-fluid" src="<?php echo $tpt_pdc_apresentacao_img_extendida; ?>" alt="<?php echo $tpt_pdc_apresentacao_titulo; ?>">
			</div>

			<?php 
			$tpt_pdc_galeria_apto_show = get_field("tpt_pdc_galeria_apto_show");
			$tpt_pdc_galeria_apto_bgcolor = get_field("tpt_pdc_galeria_apto_bgcolor");
			$tpt_pdc_galeria_apto_titulo = get_field("tpt_pdc_galeria_apto_titulo");
			$count = 0;
			if( have_rows('tpt_pdc_galeria_apto_galeria') ):
				while ( have_rows('tpt_pdc_galeria_apto_galeria') ) : the_row();
					$itens_galeria_apto[$count]["img"] = get_sub_field("tpt_pdc_galeria_apto_galeria_item_img");
					$itens_galeria_apto[$count]["img_big"] = get_sub_field("tpt_pdc_galeria_apto_galeria_item_img_big");
					$count ++;
				endwhile;
			endif;
			if ($tpt_pdc_galeria_apto_show == 1){ ?>
				<div class="wrapper-geral wrapper-geral-pdc-apto-galeria" style="background-color:<?php echo $tpt_pdc_galeria_apto_bgcolor; ?>;">
					<div class="container wrapper-inner-pdc-apto">

						<div class="row">
							<div class="col-12">
								<div class="section-content-header d-flex align-items-center flex-column">
									<h2 class="section-content-title text-center"><?php echo $tpt_pdc_galeria_apto_titulo; ?></h2>
								</div>
							</div>
						</div>
						<div class="row">
			...
			$tpt_pdc_galeria_plantas_apto_show = get_field("tpt_pdc_galeria_plantas_apto_show");
			$tpt_pdc_galeria_plantas_apto_bgcolor = get_field("tpt_pdc_galeria_plantas_apto_bgcolor");
			$tpt_pdc_galeria_plantas_apto_titulo = get_field("tpt_pdc_galeria_plantas_apto_titulo");
			$count = 0;
			if( have_rows('tpt_pdc_galeria_plantas_apto_galeria') ):
				while ( have_rows('tpt_pdc_galeria_plantas_apto_galeria') ) : the_row();
					$itens_galeria_plantas_apto[$count]["img"] = get_sub_field("tpt_pdc_galeria_plantas_apto_galeria_item_img");
					$itens_galeria_plantas_apto[$count]["img_big"] = get_sub_field("tpt_pdc_galeria_plantas_apto_galeria_item_img_big");
					$count ++;
				endwhile;
			endif;
			if ($tpt_pdc_galeria_plantas_apto_show == 1){ ?>
				<div class="wrapper-geral wrapper-geral-pdc-apto-plantas" style="background-color:<?php echo $tpt_pdc_galeria_plantas_apto_bgcolor; ?>;">
					<div class="container wrapper-inner-pdc-apto">

						<div class="row">
							<div class="col-12">
								<div class="section-content-header d-flex align-items-center flex-column">
									<h2 class="section-content-title text-center"><?php echo $tpt_pdc_galeria_plantas_apto_titulo; ?></h2>
								</div>
							</div>
						</div>
						<div class="row">
			...
			$tpt_pdc_galeria_duplex_show = get_field("tpt_pdc_galeria_duplex_show");
			$tpt_pdc_galeria_duplex_bgcolor = get_field("tpt_pdc_galeria_duplex_bgcolor");
			$tpt_pdc_galeria_duplex_titulo = get_field("tpt_pdc_galeria_duplex_titulo");
			$count = 0;
			if( have_rows('tpt_pdc_galeria_duplex_galeria') ):
				while ( have_rows('tpt_pdc_galeria_duplex_galeria') ) : the_row();
					$itens_galeria_duplex[$count]["img"] = get_sub_field("tpt_pdc_galeria_duplex_galeria_item_img");
					$itens_galeria_duplex[$count]["img_big"] = get_sub_field("tpt_pdc_galeria_duplex_galeria_item_img_big");
					$count ++;
				endwhile;
			endif;
			if ($tpt_pdc_galeria_duplex_show == 1){ ?>
				<div class="wrapper-geral wrapper-geral-pdc-apto-plantas" style="background-color:<?php echo $tpt_pdc_galeria_duplex_bgcolor; ?>;">
					<div class="container wrapper-inner-pdc-apto">

						<div class="row">
							<div class="col-12">
								<div class="section-content-header d-flex align-items-center flex-column">
									<h2 class="section-content-title text-center"><?php echo $tpt_pdc_galeria_duplex_titulo; ?></h2>
								</div>
							</div>
						</div>
						<div class="row">
			...
			$tpt_pdc_galeria_plantas_duplex_show = get_field("tpt_pdc_galeria_plantas_duplex_show");
			$tpt_pdc_galeria_plantas_duplex_bgcolor = get_field("tpt_pdc_galeria_plantas_duplex_bgcolor");
			$tpt_pdc_galeria_plantas_duplex_titulo = get_field("tpt_pdc_galeria_plantas_duplex_titulo");
			$count = 0;
			if( have_rows('tpt_pdc_galeria_plantas_duplex_galeria') ):
				while ( have_rows('tpt_pdc_galeria_plantas_duplex_galeria') ) : the_row();
					$itens_galeria_plantas_duplex[$count]["img"] = get_sub_field("tpt_pdc_galeria_plantas_duplex_galeria_item_img");
					$itens_galeria_plantas_duplex[$count]["img_big"] = get_sub_field("tpt_pdc_galeria_plantas_duplex_galeria_item_img_big");
					$count ++;
				endwhile;
			endif;
			if ($tpt_pdc_galeria_plantas_duplex_show == 1){ ?>
				<div class="wrapper-geral wrapper-geral-pdc-apto-plantas" style="background-color:<?php echo $tpt_pdc_galeria_plantas_duplex_bgcolor; ?>;">
					<div class="container wrapper-inner-pdc-apto">

						<div class="row">
							<div class="col-12">
								<div class="section-content-header d-flex align-items-center flex-column">
									<h2 class="section-content-title text-center"><?php echo $tpt_pdc_galeria_plantas_duplex_titulo; ?></h2>
								</div>
							</div>
						</div>
						<div class="row">
