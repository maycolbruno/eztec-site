<?php
/*
 * Template Name: EZ Infinity - Vídeos
...
?>
<div class="container-fluid wrapper-imovel infinity infinity-videos p-0">
	...
	<div id="primary" class="content-area">
		<main id="main" class="site-main">
						...
						<div class="wrapper-videopreview">
							<div class="video-preview-txt-container">
								<div class="wrap-titulo-banner-infinity">
									<h1 class="videopreview-titulo infinity-videos"><?php echo $tpt_infinity_banner_titulo; ?><div class="detalhe-titulo-infinity"></div></h1>
								</div>
			...
			<?php
			$tpt_infinity_videos_titulo = get_field("tpt_infinity_videos_titulo");
			$count = 1;
			...
			?>
			<div class="wrapper-geral wrapper-geral-infinity-video">
				<div class="wrapper-inner-infinity-video">
							...
							<div class="row">
								<div class="col-12">
									<div class="section-content-header d-flex align-items-center flex-column">
										<h2 class="section-content-title text-center"><?php echo $tpt_infinity_videos_titulo; ?></h2>
									</div>
								</div>
							</div>
							<div class="row">
