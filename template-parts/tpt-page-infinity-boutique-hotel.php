<?php
/*
 * Template Name: EZ Infinity - Boutique Hotel
...
?>
<div class="container-fluid wrapper-imovel infinity infinity-lazer p-0">
	...
	<div id="primary" class="content-area">
		<main id="main" class="site-main">
						...
						<div class="wrapper-videopreview">
							<div class="video-preview-txt-container">
								<div class="wrap-titulo-banner-infinity">
									<h1 class="videopreview-titulo infinity-lazer"><?php echo $tpt_infinity_banner_titulo; ?><div class="detalhe-titulo-infinity"></div></h1>
								</div>
			...
			$tpt_infinity_apresentacao_677x374_img = get_field("tpt_infinity_apresentacao_677x374_img");
			?>

			<div class="wrapper-geral wrapper-geral-infinity-apresentacao">
				<div class="wrapper-inner-infinity-apresentacao-lazer">
					<div class="container-fluid p-0">
						<div class="row p-0">
							...
							<div class="sec-apresentacao-right col-xl-5 col-lg-5 col-12">
								...
								<img class="img-677x374 img-fluid" src="<?php echo $tpt_infinity_apresentacao_677x374_img; ?>" alt="<?php echo $tpt_infinity_apresentacao_titulo; ?>">
							</div>
						</div>
					</div>
				</div>
			...
			<?php 
			$tpt_infinity_galeria_lazer_show = get_field("tpt_infinity_galeria_lazer_show");
			$tpt_infinity_galeria_lazer_bgcolor = get_field("tpt_infinity_galeria_lazer_bgcolor");
			$tpt_infinity_galeria_lazer_titulo = get_field("tpt_infinity_galeria_lazer_titulo");
			$count = 0;
			if( have_rows('tpt_infinity_galeria_lazer_galeria') ):
				while ( have_rows('tpt_infinity_galeria_lazer_galeria') ) : the_row();
					$itens_galeria_lazer[$count]["img"] = get_sub_field("tpt_infinity_galeria_lazer_galeria_item_img");
					$itens_galeria_lazer[$count]["img_big"] = get_sub_field("tpt_infinity_galeria_lazer_galeria_item_img_big");
					$count ++;
				endwhile;
			endif;
			if ($tpt_infinity_galeria_lazer_show == 1){ ?>
				<div class="wrapper-geral wrapper-geral-infinity-lazer-galeria" style="background-color:<?php echo $tpt_infinity_galeria_lazer_bgcolor; ?>;">
					<div class="container wrapper-inner-infinity-lazer">

						<div class="row">
							<div class="col-12">
								<div class="section-content-header d-flex align-items-center flex-column">
									<h2 class="section-content-title text-center"><?php echo $tpt_infinity_galeria_lazer_titulo; ?></h2>
								</div>
							</div>
						</div>
						<div class="row">
									...
									<div class="col-12 col-md-10 col-lg-8 d-flex justify-content-center">
										<div class="image-gallery-box">
											<ul id="galeria-lazer" class="gallery list-unstyled">
												<?php
												foreach($itens_galeria_lazer as $img){
			...
			$tpt_infinity_galeria_plantas_lazer_show = get_field("tpt_infinity_galeria_plantas_lazer_show");
			$tpt_infinity_galeria_plantas_lazer_bgcolor = get_field("tpt_infinity_galeria_plantas_lazer_bgcolor");
			$tpt_infinity_galeria_plantas_lazer_titulo = get_field("tpt_infinity_galeria_plantas_lazer_titulo");
			$count = 0;
			if( have_rows('tpt_infinity_galeria_plantas_lazer_galeria') ):
				while ( have_rows('tpt_infinity_galeria_plantas_lazer_galeria') ) : the_row();
					$itens_galeria_plantas_lazer[$count]["img"] = get_sub_field("tpt_infinity_galeria_plantas_lazer_galeria_item_img");
					$itens_galeria_plantas_lazer[$count]["img_big"] = get_sub_field("tpt_infinity_galeria_plantas_lazer_galeria_item_img_big");
					$count ++;
				endwhile;
			endif;
			if ($tpt_infinity_galeria_plantas_lazer_show == 1){ ?>
				<div class="wrapper-geral wrapper-geral-infinity-lazer-plantas" style="background-color:<?php echo $tpt_infinity_galeria_plantas_lazer_bgcolor; ?>;">
					<div class="container wrapper-inner-infinity-lazer">

						<div class="row">
							<div class="col-12">
								<div class="section-content-header d-flex align-items-center flex-column">
									<h2 class="section-content-title text-center"><?php echo $tpt_infinity_galeria_plantas_lazer_titulo; ?></h2>
								</div>
							</div>
						</div>
						<div class="row">
									...
									<div class="col-12 col-md-10 col-lg-8 d-flex justify-content-center">
										<div class="image-gallery-box">
											<ul id="galeria-plantas" class="gallery list-unstyled">
												<?php
												foreach($itens_galeria_plantas_lazer as $img){
													$imagem = wp_get_attachment_metadata( $img["img"], true );
													$upload_dir = wp_upload_dir();
													$path_img =  dirname($imagem["file"]);
													$url_img_xs = $upload_dir["baseurl"] . "/" . $path_img . "/" . $imagem["sizes"]["545x319"]["file"];
