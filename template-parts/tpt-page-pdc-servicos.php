<?php
/*
 * Template Name: Parque da Cidade - Serviços
...
?>
<div class="container-fluid wrapper-imovel pdc pdc-servicos p-0">
	...
	<div id="primary" class="content-area">
		<main id="main" class="site-main">
						...
						<div class="wrapper-videopreview">
							<div class="video-preview-txt-container">
								<div class="wrap-titulo-banner-pdc">
									<h1 class="videopreview-titulo pdc-servicos"><?php echo $tpt_pdc_banner_titulo; ?><div class="detalhe-titulo-pdc"></div></h1>
								</div>
			...
			<?php
			$tpt_pdc_servicos_zservices_titulo = get_field("tpt_pdc_servicos_zservices_titulo");
			$tpt_pdc_servicos_zservices_chamada = get_field("tpt_pdc_servicos_zservices_chamada");
			$tpt_pdc_servicos_zservices_desc = get_field("tpt_pdc_servicos_zservices_desc");
			$tpt_pdc_servicos_zservices_img_548x685 = get_field("tpt_pdc_servicos_zservices_img_548x685");
			$tpt_pdc_servicos_zservices_img_315x423 = get_field("tpt_pdc_servicos_zservices_img_315x423");
			$tpt_pdc_servicos_zservices_img_658x385 = get_field("tpt_pdc_servicos_zservices_img_658x385");
			$tpt_pdc_servicos_zservices_img_1018x676 = get_field("tpt_pdc_servicos_zservices_img_1018x676");
			$tpt_pdc_servicos_zservices_bgimg = get_field("tpt_pdc_servicos_zservices_bgimg");
			$tpt_pdc_servicos_zservices_logo = get_field("tpt_pdc_servicos_zservices_logo");
			$tpt_pdc_servicos_zservices_desc_list = get_field("tpt_pdc_servicos_zservices_desc_list");
			$tpt_pdc_servicos_zservices_patrimonial = get_field("tpt_pdc_servicos_zservices_patrimonial");
			$tpt_pdc_servicos_zservices_txt_legal = get_field("tpt_pdc_servicos_zservices_txt_legal");
			?>
			<div class="wrapper-geral wrapper-geral-servicos">
				<div class="wrapper-inner-servicos">
					<div class="container-zservices container-fluid">
						<div class="row">
							<div class="col-xl-3 col-lg-2 col-12"></div>
							<div class="z-services-apresentacao col-xl-3 col-lg-4 col-12">
								<div class="wrapper-zservices-info">
									<h2 class="apresentacao-info-titulo"><?php echo $tpt_pdc_servicos_zservices_titulo; ?></h2>
									<div class="apresentacao-divisor-pdc"></div>
									<p class="apresentacao-info-chamada"><?php echo $tpt_pdc_servicos_zservices_chamada; ?></p>
									<p class="apresentacao-info-desc"><?php echo $tpt_pdc_servicos_zservices_desc; ?></p>
								</div>
							</div>
							<div class="z-services-imgs-topo1 col-xl-3 col-lg-3 col-12">
								<img class="zservices-img-topo1 img-fluid" src="<?php echo $tpt_pdc_servicos_zservices_img_548x685; ?>">
							</div>
							<div class="z-services-imgs-topo2 col-xl-3 col-lg-3 col-12">
								<img class="zservices-img-topo2" src="<?php echo $tpt_pdc_servicos_zservices_img_315x423; ?>">
							</div>
						</div>
						<div class="row">
							<div class="z-services-imgs col-xl-4 col-lg-4 col-12">
								<img class="zservices-img1" src="<?php echo $tpt_pdc_servicos_zservices_img_658x385; ?>">
							</div>
							<div class="z-services-imgs col-xl-8 col-lg-8 col-12">
								<img class="zservices-img2" src="<?php echo $tpt_pdc_servicos_zservices_img_1018x676; ?>">
							</div>
						</div>
					</div>
				</div>
			...
			<div class="wrapper-geral wrapper-geral-servicos-list">
				<div class="wrapper-inner-servicos-list">
					<div class="container-servicos-list container-fluid">
						<div class="row">
							<div class="wrap-logo-zservices col-xl-2 col-lg-2 col-12">
								<img src="<?php echo $tpt_pdc_servicos_zservices_logo; ?>" class="logo-zservices">
							</div>
							<div class="wrap-list-zservices col-xl-6 col-lg-6 col-12">
								<p class="list-zservices"><?php echo $tpt_pdc_servicos_zservices_desc_list; ?></p>
							</div>
							<div class="wrap-patrimonial col-xl-4 col-lg-4 col-12">
								<p class="patrimonial"><?php echo $tpt_pdc_servicos_zservices_patrimonial; ?></p>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="wrapper-geral wrapper-geral-servicos">
				<div class="wrapper-inner-txt-legal-servicos">
					<p class="txt-legal-servicos"><?php echo $tpt_pdc_servicos_zservices_txt_legal; ?></p>
				</div>
			</div>
