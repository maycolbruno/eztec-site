<?php
/*
 * Template Name: Parque da Cidade - Investimento
...
<div class="container-fluid wrapper-imovel pdc pdc-complexo p-0">
	...
	<div id="primary" class="content-area">
		<main id="main" class="site-main">
			...
			<?php 
			$tpt_pdc_investimento_oportunidades_titulo = get_field("tpt_pdc_investimento_oportunidades_titulo");
			$tpt_pdc_investimento_oportunidades_chamada = get_field("tpt_pdc_investimento_oportunidades_chamada");
			$tpt_pdc_investimento_oportunidades_desc = get_field("tpt_pdc_investimento_oportunidades_desc");
			$tpt_pdc_investimento_oportunidades_img = get_field("tpt_pdc_investimento_oportunidades_img");
			$tpt_pdc_investimento_oportunidades_dif1 = get_field("tpt_pdc_investimento_oportunidades_dif1");
			$tpt_pdc_investimento_oportunidades_dif2 = get_field("tpt_pdc_investimento_oportunidades_dif2");
			$tpt_pdc_investimento_oportunidades_dif3 = get_field("tpt_pdc_investimento_oportunidades_dif3");
			$tpt_pdc_investimento_oportunidades_dif4 = get_field("tpt_pdc_investimento_oportunidades_dif4");
			$tpt_pdc_investimento_oportunidades_dif5 = get_field("tpt_pdc_investimento_oportunidades_dif5");
			?>
			<div class="wrapper-geral wrapper-geral-pdc-investimento-oportunidades">
				<div class="wrapper-inner-pdc-investimento-oportunidades">
					<div class="container-investimento-oportunidades container-fluid">
						<div class="row">
							<div class="wrap-oportunidades-info col-xl-6 col-lg-6 col-12">
								<h2 class="apresentacao-info-titulo"><?php echo $tpt_pdc_investimento_oportunidades_titulo; ?></h2>
								<div class="apresentacao-divisor-pdc"></div>
								<p class="apresentacao-info-chamada"><?php echo $tpt_pdc_investimento_oportunidades_chamada; ?></p>
								<p class="apresentacao-info-desc"><?php echo $tpt_pdc_investimento_oportunidades_desc; ?></p>
								<div class="wrap-oportunidades-img">
									<img class="oportunidades-img" src="<?php echo $tpt_pdc_investimento_oportunidades_img; ?>">
								</div>
								<div class="wrap-oportunidades-diferenciais">
									<p class="oportunidades-dif"><?php echo $tpt_pdc_investimento_oportunidades_dif1; ?></p>
								</div>
							</div>
							<div class="wrap-oportunidades-info col-xl-6 col-lg-6 col-12">
								<div class="wrap-oportunidades-diferenciais">
									<div class="oportunidades-dif"><?php echo $tpt_pdc_investimento_oportunidades_dif2; ?></div>
									<div class="oportunidades-dif"><?php echo $tpt_pdc_investimento_oportunidades_dif3; ?></div>
									<div class="oportunidades-dif"><?php echo $tpt_pdc_investimento_oportunidades_dif4; ?></div>
									<div class="oportunidades-dif"><?php echo $tpt_pdc_investimento_oportunidades_dif5; ?></div>
								</div>
							</div>
						</div>
					</div>
			...
			<?php
			$tpt_pdc_investimento_pib_titulo = get_field("tpt_pdc_investimento_pib_titulo");
			$tpt_pdc_investimento_pib_desc = get_field("tpt_pdc_investimento_pib_desc");
			$count = 0;
			if( have_rows('tpt_pdc_investimento_pib_logos') ):
				while ( have_rows('tpt_pdc_investimento_pib_logos') ) : the_row();
					$itens_pib[$count]['titulo'] = get_sub_field("tpt_pdc_investimento_pib_logo_titulo");
					$itens_pib[$count]['img'] = get_sub_field("tpt_pdc_investimento_pib_logo_titulo_img");
					$count ++;
				endwhile;
			endif;
			?>
			<div class="wrapper-geral wrapper-geral-pdc-investimento-pib">
				<div class="wrapper-inner-pdc-investimento-pib">
					<div class="container-fluid container-investimento-pib">
						<div class="row">
							<div class="wrap-investimento-info col-xl-6 col-lg-6 col-12">
								<div class="wrap-oportunidades-diferenciais">
									<div class="oportunidades-dif pib"><?php echo $tpt_pdc_investimento_pib_titulo; ?></div>
								</div>
							</div>
							<div class="wrap-investimento-info col-xl-6 col-lg-6 col-12">
								<div class="wrap-oportunidades-diferenciais">
									<div class="oportunidades-dif pib"><?php echo $tpt_pdc_investimento_pib_desc; ?></div>
								</div>
							</div>
						</div>
						<div class="row">
							<?php 
							foreach ($itens_pib as $i){
								echo '
								<div class="wrap-img-pib col-xl-2 col-lg-2 col-md-3 col-sm-4 col-6">
