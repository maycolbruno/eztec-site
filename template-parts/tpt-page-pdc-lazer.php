<?php
/*
 * Template Name: Parque da Cidade - Lazer
...
?>
<div class="container-fluid wrapper-imovel pdc pdc-lazer p-0">
	...
	<div id="primary" class="content-area">
		<main id="main" class="site-main">
						...
						<div class="wrapper-videopreview">
							<div class="video-preview-txt-container">
								<div class="wrap-titulo-banner-pdc">
									<h1 class="videopreview-titulo pdc-lazer"><?php echo $tpt_pdc_banner_titulo; ?><div class="detalhe-titulo-pdc"></div></h1>
								</div>
			...
			<div class="wrapper-geral wrapper-geral-pdc-apresentacao">
				<div class="wrapper-inner-pdc-apresentacao-lazer">
			...
			<?php 
			$tpt_pdc_galeria_lazer_show = get_field("tpt_pdc_galeria_lazer_show");
			$tpt_pdc_galeria_lazer_bgcolor = get_field("tpt_pdc_galeria_lazer_bgcolor");
			$tpt_pdc_galeria_lazer_titulo = get_field("tpt_pdc_galeria_lazer_titulo");
			$count = 0;
			if( have_rows('tpt_pdc_galeria_lazer_galeria') ):
				while ( have_rows('tpt_pdc_galeria_lazer_galeria') ) : the_row();
					$itens_galeria_lazer[$count]["img"] = get_sub_field("tpt_pdc_galeria_lazer_galeria_item_img");
					$itens_galeria_lazer[$count]["img_big"] = get_sub_field("tpt_pdc_galeria_lazer_galeria_item_img_big");
					$count ++;
				endwhile;
			endif;
			if ($tpt_pdc_galeria_lazer_show == 1){ ?>
				<div class="wrapper-geral wrapper-geral-pdc-lazer-galeria" style="background-color:<?php echo $tpt_pdc_galeria_lazer_bgcolor; ?>;">
					<div class="container wrapper-inner-pdc-lazer">

						<div class="row">
							<div class="col-12">
								<div class="section-content-header d-flex align-items-center flex-column">
									<h2 class="section-content-title text-center"><?php echo $tpt_pdc_galeria_lazer_titulo; ?></h2>
								</div>
							</div>
						</div>
						<div class="row">
			...
			$tpt_pdc_galeria_plantas_lazer_show = get_field("tpt_pdc_galeria_plantas_lazer_show");
			$tpt_pdc_galeria_plantas_lazer_bgcolor = get_field("tpt_pdc_galeria_plantas_lazer_bgcolor");
			$tpt_pdc_galeria_plantas_lazer_titulo = get_field("tpt_pdc_galeria_plantas_lazer_titulo");
			$count = 0;
			if( have_rows('tpt_pdc_galeria_plantas_lazer_galeria') ):
				while ( have_rows('tpt_pdc_galeria_plantas_lazer_galeria') ) : the_row();
					$itens_galeria_plantas_lazer[$count]["img"] = get_sub_field("tpt_pdc_galeria_plantas_lazer_galeria_item_img");
					$itens_galeria_plantas_lazer[$count]["img_big"] = get_sub_field("tpt_pdc_galeria_plantas_lazer_galeria_item_img_big");
					$count ++;
				endwhile;
			endif;
			if ($tpt_pdc_galeria_plantas_lazer_show == 1){ ?>
				<div class="wrapper-geral wrapper-geral-pdc-lazer-plantas" style="background-color:<?php echo $tpt_pdc_galeria_plantas_lazer_bgcolor; ?>;">
					<div class="container wrapper-inner-pdc-lazer">

						<div class="row">
							<div class="col-12">
								<div class="section-content-header d-flex align-items-center flex-column">
									<h2 class="section-content-title text-center"><?php echo $tpt_pdc_galeria_plantas_lazer_titulo; ?></h2>
								</div>
							</div>
						</div>
						<div class="row">
