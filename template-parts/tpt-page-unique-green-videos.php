<?php
/*
 * Template Name: Unique Green - Vídeos
				...
				<div class="wrapper-geral">
					<div class="wrapper-inner">
						...
						<ul class="nav nav-tabs" id="TabVideos" role="tablist">
							...
							echo '
							<li class="nav-item">
								<a class="nav-link' . $class_active . '" id="videosTab-tab" data-toggle="tab" href="#videosTab" role="tab" aria-controls="videosTab" aria-selected="' . $aria_att . '">' . get_field("imoveis_titulo_videos") . '</a>
							</li>
							';
							$class_active = "";
							$aria_att = "false";
							...
							echo '
							<li class="nav-item">
								<a class="nav-link' . $class_active . '" id="tourTab-tab" data-toggle="tab" href="#tourTab" role="tab" aria-controls="tourTab" aria-selected="' . $aria_att . '">' . get_field("imoveis_titulo_tour") . '</a>
							</li>
							';
							$class_active = "";
							$aria_att = "false";
