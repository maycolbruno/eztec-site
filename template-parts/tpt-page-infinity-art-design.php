<?php
/*
 * Template Name: EZ Infinity - Art Design
...
?>
<div class="container-fluid wrapper-imovel infinity infinity-artdesign p-0">
	...
	<div id="primary" class="content-area">
		<main id="main" class="site-main">
						...
						<div class="wrapper-videopreview">
							<div class="video-preview-txt-container">
								<div class="wrap-titulo-banner-infinity">
									<h1 class="videopreview-titulo infinity-artdesign"><?php echo $tpt_infinity_banner_titulo; ?><div class="detalhe-titulo-infinity"></div></h1>
								</div>
			...
			<?php
			$tpt_infinity_artdesign_art_titulo = get_field("tpt_infinity_artdesign_art_titulo");
			$tpt_infinity_artdesign_art_chamada = get_field("tpt_infinity_artdesign_art_chamada");
			$tpt_infinity_artdesign_art_citacao = get_field("tpt_infinity_artdesign_art_citacao");
			$tpt_infinity_artdesign_art_desc = get_field("tpt_infinity_artdesign_art_desc");
			$tpt_infinity_artdesign_art_grafismo = get_field("tpt_infinity_artdesign_art_grafismo");
			$tpt_infinity_artdesign_art_img_725x600 = get_field("tpt_infinity_artdesign_art_img_725x600");
			$tpt_infinity_artdesign_art_img_787x385 = get_field("tpt_infinity_artdesign_art_img_787x385");
			$tpt_infinity_artdesign_art_img_300x300 = get_field("tpt_infinity_artdesign_art_img_300x300");
			?>
			<div class="wrapper-geral wrapper-geral-artdesign">
				<div class="wrapper-inner-artdesign-art">
					<div class="container-artdesign-art container-fluid">
						<div class="row">
							<div class="wrap-art-img-topo col-xl-6 col-lg-6 col-12">
								<img class="art-img-topo img-fluid" src="<?php echo $tpt_infinity_artdesign_art_img_725x600; ?>">
							</div>
							<div class="wrap-art-txt col-xl-6 col-lg-6 col-12">
								<div class="art-txt" style="background-image:url('<?php echo $tpt_infinity_artdesign_art_grafismo; ?>')">
									<h2 class="apresentacao-info-titulo"><?php echo $tpt_infinity_artdesign_art_titulo; ?></h2>
									<div class="apresentacao-divisor-infinity"></div>
									<p class="apresentacao-info-chamada-artdesign"><?php echo $tpt_infinity_artdesign_art_chamada; ?></p>
									<p class="apresentacao-info-desc-artdesign"><?php echo $tpt_infinity_artdesign_art_desc; ?></p>
								</div>
							</div>
						</div>
						<div class="row row-imgs-art">
							<div class="wrap-art-citacao col-xl-6 col-lg-6 col-12">
								<div class="citacao-box-art d-flex align-items-center">
									<p class="citacao-art"><?php echo $tpt_infinity_artdesign_art_citacao; ?></p>
									<img src="<?php echo $tpt_infinity_artdesign_art_img_300x300; ?>">
								</div>
							</div>
							<div class="wrap-art-img col-xl-6 col-lg-6 col-12">
								<img src="<?php echo $tpt_infinity_artdesign_art_img_787x385; ?>">
							</div>
						</div>
					</div>
				</div>
			...
			<?php
			$tpt_infinity_artdesign_paisagistico_titulo = get_field("tpt_infinity_artdesign_paisagistico_titulo");
			$tpt_infinity_artdesign_paisagistico_desc = get_field("tpt_infinity_artdesign_paisagistico_desc");
			$tpt_infinity_artdesign_paisagistico_img = get_field("tpt_infinity_artdesign_paisagistico_img");
			$tpt_infinity_artdesign_paisagistico_logo = get_field("tpt_infinity_artdesign_paisagistico_logo");

			$tpt_infinity_artdesign_interiores_titulo = get_field("tpt_infinity_artdesign_interiores_titulo");
			$tpt_infinity_artdesign_interiores_desc = get_field("tpt_infinity_artdesign_interiores_desc");
			$tpt_infinity_artdesign_interiores_img = get_field("tpt_infinity_artdesign_interiores_img");
			$tpt_infinity_artdesign_interiores_logo = get_field("tpt_infinity_artdesign_interiores_logo");
			?>
			<div class="wrapper-geral wrapper-geral-paisagistico-interiores">
				<div class="wrapper-inner-artdesign-paisagistico-interiores">
					<div class="container-interiores container-fluid">
						<div class="row">
							<div class="item-interiores col-xl-6 col-lg-6 col-12">
								<img class="imagem-interiores" src="<?php echo $tpt_infinity_artdesign_interiores_img; ?>">
								<h2 class="apresentacao-info-titulo"><?php echo $tpt_infinity_artdesign_interiores_titulo; ?></h2>
								<div class="apresentacao-divisor-infinity"></div>
								<p class="apresentacao-info-desc"><?php echo $tpt_infinity_artdesign_interiores_desc; ?></p>
								<div class="wrap-logo-interiores">
									<img src="<?php echo $tpt_infinity_artdesign_interiores_logo; ?>">
								</div>
							</div>
							<div class="item-interiores col-xl-6 col-lg-6 col-12">
								<img class="imagem-interiores" src="<?php echo $tpt_infinity_artdesign_paisagistico_img; ?>">
								<h2 class="apresentacao-info-titulo"><?php echo $tpt_infinity_artdesign_paisagistico_titulo; ?></h2>
								<div class="apresentacao-divisor-infinity"></div>
								<p class="apresentacao-info-desc"><?php echo $tpt_infinity_artdesign_paisagistico_desc; ?></p>
								<div class="wrap-logo-interiores">
									<img src="<?php echo $tpt_infinity_artdesign_paisagistico_logo; ?>">
								</div>
							</div>
						</div>
					</div>
