	...
	<div class="container-fluid wrapper-home p-0">
		...
		<?php
		// Seções
		if( have_rows('secoes_de_conteudo_fl3') ):
			while ( have_rows('secoes_de_conteudo_fl3') ) : the_row();
				$show_session = get_sub_field("show_session_fl3");
				$layout = get_sub_field("layout_secao_fl3");
				if($show_session == 1){
					$tipo_de_layout = get_sub_field("layout_secao_fl3");
					$isMobileVisible = "";
					$isMobileVisible = (get_sub_field("show_session_mobile_fl3") == 1 ? '': 'd-none d-md-block');

					// Layout Lançamentos
					if ($tipo_de_layout == "lancamentos"){
						$bg_color = get_sub_field("bg_color_secao_lancamentos_fl3");
						$titulo_secao_lancamentos = get_sub_field("titulo_secao_lancamentos_fl3");
						$desc_secao_lancamentos = get_sub_field("desc_secao_lancamentos_fl3");
						$itens_lancamentos = array();
						$count = 0;
						if( have_rows('itens_da_secao_de_lancamentos') ):
							while ( have_rows('itens_da_secao_de_lancamentos') ) : the_row();
								$itens_lancamentos[$count]['status'] = get_sub_field("item_secao_lancamentos_status_fl3");
								$itens_lancamentos[$count]['titulo'] = get_sub_field("item_secao_lancamentos_titulo_fl3");
								$itens_lancamentos[$count]['regiao'] = get_sub_field("item_secao_lancamentos_regiao_fl3");
								$itens_lancamentos[$count]['box'] = get_sub_field("item_secao_lancamentos_box_fl3");
								$itens_lancamentos[$count]['img'] = get_sub_field("item_secao_lancamentos_img_fl3");
								$itens_lancamentos[$count]['url'] = get_sub_field("item_secao_lancamentos_url_fl3");
								$count ++;
							endwhile;
						endif;
						echo '
					...
					if ($tipo_de_layout == "destaques"){
						$bg_color = get_sub_field("bg_color_secao_destaques_fl3");
						$titulo_secao_destaques = get_sub_field("titulo_secao_destaques_fl3");
						$desc_secao_destaques = get_sub_field("desc_secao_destaques_fl3");
						$item_main_secao_destaques_status = get_sub_field("item_main_secao_destaques_status_fl3");
						$item_main_secao_destaques_titulo = get_sub_field("item_main_secao_destaques_titulo_fl3");
						$item_main_secao_destaques_regiao = get_sub_field("item_main_secao_destaques_regiao_fl3");
						$item_main_secao_destaques_box = get_sub_field("item_main_secao_destaques_box_fl3");
						$item_main_secao_destaques_img = get_sub_field("item_main_secao_destaques_img_fl3");
						$item_main_secao_destaques_img_menor = get_sub_field("item_main_secao_destaques_img_menor_fl3");
						$item_main_secao_destaques_url = get_sub_field("item_main_secao_destaques_url_fl3");
						$count = 0;
						$itens_destaques = array();
						if( have_rows('itens_secao_destaques_fl3') ):
							while ( have_rows('itens_secao_destaques_fl3') ) : the_row();
								$itens_destaques[$count]['status'] = get_sub_field("item_secao_destaques_status_fl3");
								$itens_destaques[$count]['titulo'] = get_sub_field("item_secao_destaque_titulo_fl3");
								$itens_destaques[$count]['regiao'] = get_sub_field("item_secao_destaques_regiao_fl3");
								$itens_destaques[$count]['box'] = get_sub_field("item_secao_destaques_box_fl3");
								$itens_destaques[$count]['img'] = get_sub_field("item_secao_destaques_img_fl3");
								$itens_destaques[$count]['url'] = get_sub_field("item_secao_destaques_url_fl3");
								$count ++;
							endwhile;
						endif;
						echo '
					...
					if ($tipo_de_layout == "livre"){
						$livre_content = get_sub_field("conteudo_secao_livre_fl3");
						echo '
					...
					if ($tipo_de_layout == "blog"){
						$bg_color = get_sub_field("bg_color_secao_blog_fl3");
						$bg_img = get_sub_field("bg_img_secao_blog_fl3");
						$status_secao_blog = get_sub_field("status_secao_blog_fl3");
						$titulo_secao_blog = get_sub_field("titulo_secao_blog_fl3");
						$txt_btn_secao_blog = get_sub_field("txt_btn_secao_blog_fl3");
						echo '
					...
					if ($tipo_de_layout == "regiao"){
						$bg_color = get_sub_field("bg_color_secao_regiao_fl3");
						$titulo_secao_regiao = get_sub_field("titulo_secao_regiao_fl3");
						$desc_secao_regiao = get_sub_field("desc_secao_regiao_fl3");
						$count = 0;
						$itens_regiao = array();
						if( have_rows('itens_secao_regiao_fl3') ):
							while ( have_rows('itens_secao_regiao_fl3') ) : the_row();
								$itens_regiao[$count]['titulo'] = get_sub_field("item_secao_regiao_fl_titulo_fl3");
								$itens_regiao[$count]['url'] = get_sub_field("item_secao_regiao_fl_url_fl3");
								$itens_regiao[$count]['img'] = get_sub_field("item_secao_regiao_fl_img_fl3");
								$count ++;
							endwhile;
						endif;
