<?php
/*
 * Template Name: EZ Infinity - Apartamentos
...
?>
<div class="container-fluid wrapper-imovel infinity infinity-aptos p-0">
	...
	<div id="primary" class="content-area">
		<main id="main" class="site-main">
						...
						<div class="wrapper-videopreview">
							<div class="video-preview-txt-container">
								<div class="wrap-titulo-banner-infinity">
									<h1 class="videopreview-titulo infinity-aptos"><?php echo $tpt_infinity_banner_titulo; ?><div class="detalhe-titulo-infinity"></div></h1>
								</div>
			...
			$tpt_infinity_apresentacao_show = get_field("tpt_infinity_show_apresentacao");
			$tpt_infinity_apresentacao_titulo = get_field("tpt_infinity_apresentacao_titulo");
			$tpt_infinity_apresentacao_chamada = get_field("tpt_infinity_apresentacao_chamada");
			$tpt_infinity_apresentacao_desc = get_field("tpt_infinity_apresentacao_desc");
			$tpt_infinity_apresentacao_box = get_field("tpt_infinity_apresentacao_box");
			$tpt_infinity_apresentacao_img = get_field("tpt_infinity_apresentacao_img");
			$tpt_infinity_apresentacao_citacao_img = get_field("tpt_infinity_apresentacao_citacao_img");
			$tpt_infinity_apresentacao_img_extendida = get_field("tpt_infinity_apresentacao_img_extendida");
			?>

			<div class="wrapper-geral wrapper-geral-infinity-apresentacao">
				<div class="wrapper-inner-infinity-apresentacao-apto">
					<div class="container-fluid p-0">
						<div class="row p-0">
							<div class="sec-apresentacao-left col-xl-7 col-lg-7 col-12">
								<div class="wrap-apresentacao-left-txt">
									<div class="apresentacao-info">
										<h2 class="apresentacao-info-titulo"><?php echo $tpt_infinity_apresentacao_titulo; ?></h2>
										<div class="apresentacao-divisor-infinity"></div>
										<p class="apresentacao-info-chamada"><?php echo $tpt_infinity_apresentacao_chamada; ?></p>
										<p class="apresentacao-info-desc"><?php echo $tpt_infinity_apresentacao_desc; ?></p>
									</div>
								</div>
								<div class="wrap-img-apresentacao-infinity">
									<img class="img-apresentacao-infinity img-fluid" src="<?php echo $tpt_infinity_apresentacao_citacao_img; ?>" alt="<?php echo $tpt_infinity_apresentacao_titulo; ?>">
								</div>
							</div>
							<div class="sec-apresentacao-right col-xl-5 col-lg-5 col-12">
								<img class="img-citacao img-fluid" src="<?php echo $tpt_infinity_apresentacao_img; ?>" alt="<?php echo $tpt_infinity_apresentacao_titulo; ?>">
								<div class="wrapper-box-produto-infinity-aptos">
									<?php echo $tpt_infinity_apresentacao_box; ?>
								</div>
							</div>
						</div>
					</div>
			...
			<div class="wrapper-geral">
				<img class="img-extendida-infinity img-fluid" src="<?php echo $tpt_infinity_apresentacao_img_extendida; ?>" alt="<?php echo $tpt_infinity_apresentacao_titulo; ?>">
			</div>

			<?php 
			$tpt_infinity_galeria_apto_show = get_field("tpt_infinity_galeria_apto_show");
			$tpt_infinity_galeria_apto_bgcolor = get_field("tpt_infinity_galeria_apto_bgcolor");
			$tpt_infinity_galeria_apto_titulo = get_field("tpt_infinity_galeria_apto_titulo");
			$count = 0;
			if( have_rows('tpt_infinity_galeria_apto_galeria') ):
				while ( have_rows('tpt_infinity_galeria_apto_galeria') ) : the_row();
					$itens_galeria_apto[$count]["img"] = get_sub_field("tpt_infinity_galeria_apto_galeria_item_img");
					$itens_galeria_apto[$count]["img_big"] = get_sub_field("tpt_infinity_galeria_apto_galeria_item_img_big");
					$count ++;
				endwhile;
			endif;
			if ($tpt_infinity_galeria_apto_show == 1){ ?>
				<div class="wrapper-geral wrapper-geral-infinity-apto-galeria" style="background-color:<?php echo $tpt_infinity_galeria_apto_bgcolor; ?>;">
					<div class="container wrapper-inner-infinity-apto">

						<div class="row">
							<div class="col-12">
								<div class="section-content-header d-flex align-items-center flex-column">
									<h2 class="section-content-title text-center"><?php echo $tpt_infinity_galeria_apto_titulo; ?></h2>
								</div>
							</div>
						</div>
						<div class="row">
									...
									<div class="col-12 col-md-10 col-lg-8 d-flex justify-content-center">
										<div class="image-gallery-box">
											<ul id="galeria-apartamentos" class="gallery list-unstyled">
												<?php
												foreach($itens_galeria_apto as $img){
			...
			$tpt_infinity_galeria_plantas_apto_show = get_field("tpt_infinity_galeria_plantas_apto_show");
			$tpt_infinity_galeria_plantas_apto_bgcolor = get_field("tpt_infinity_galeria_plantas_apto_bgcolor");
			$tpt_infinity_galeria_plantas_apto_titulo = get_field("tpt_infinity_galeria_plantas_apto_titulo");
			$count = 0;
			if( have_rows('tpt_infinity_galeria_plantas_apto_galeria') ):
				while ( have_rows('tpt_infinity_galeria_plantas_apto_galeria') ) : the_row();
					$itens_galeria_plantas_apto[$count]["img"] = get_sub_field("tpt_infinity_galeria_plantas_apto_galeria_item_img");
					$itens_galeria_plantas_apto[$count]["img_big"] = get_sub_field("tpt_infinity_galeria_plantas_apto_galeria_item_img_big");
					$count ++;
				endwhile;
			endif;
			if ($tpt_infinity_galeria_plantas_apto_show == 1){ ?>
				<div class="wrapper-geral wrapper-geral-infinity-apto-plantas" style="background-color:<?php echo $tpt_infinity_galeria_plantas_apto_bgcolor; ?>;">
					<div class="container wrapper-inner-infinity-apto">

						<div class="row">
							<div class="col-12">
								<div class="section-content-header d-flex align-items-center flex-column">
									<h2 class="section-content-title text-center"><?php echo $tpt_infinity_galeria_plantas_apto_titulo; ?></h2>
								</div>
							</div>
						</div>
						<div class="row">
									...
									<div class="col-12 col-md-10 col-lg-8 d-flex justify-content-center">
										<div class="image-gallery-box">
											<ul id="galeria-plantas" class="gallery list-unstyled">
												<?php
												foreach($itens_galeria_plantas_apto as $img){
													$imagem = wp_get_attachment_metadata( $img["img"], true );
													$upload_dir = wp_upload_dir();
													$path_img =  dirname($imagem["file"]);
													$url_img_xs = $upload_dir["baseurl"] . "/" . $path_img . "/" . $imagem["sizes"]["545x319"]["file"];
			...
			$tpt_infinity_galeria_duplex_show = get_field("tpt_infinity_galeria_duplex_show");
			$tpt_infinity_galeria_duplex_bgcolor = get_field("tpt_infinity_galeria_duplex_bgcolor");
			$tpt_infinity_galeria_duplex_titulo = get_field("tpt_infinity_galeria_duplex_titulo");
			$count = 0;
			if( have_rows('tpt_infinity_galeria_duplex_galeria') ):
				while ( have_rows('tpt_infinity_galeria_duplex_galeria') ) : the_row();
					$itens_galeria_duplex[$count]["img"] = get_sub_field("tpt_infinity_galeria_duplex_galeria_item_img");
					$itens_galeria_duplex[$count]["img_big"] = get_sub_field("tpt_infinity_galeria_duplex_galeria_item_img_big");
					$count ++;
				endwhile;
			endif;
			if ($tpt_infinity_galeria_duplex_show == 1){ ?>
				<div class="wrapper-geral wrapper-geral-infinity-apto-plantas" style="background-color:<?php echo $tpt_infinity_galeria_duplex_bgcolor; ?>;">
					<div class="container wrapper-inner-infinity-apto">

						<div class="row">
							<div class="col-12">
								<div class="section-content-header d-flex align-items-center flex-column">
									<h2 class="section-content-title text-center"><?php echo $tpt_infinity_galeria_duplex_titulo; ?></h2>
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col-12">
								<div class="row d-flex justify-content-center">
									<div class="col-12 col-md-10 col-lg-8 d-flex justify-content-center">
										<div class="image-gallery-box">
											<ul id="galeria-duplex" class="gallery list-unstyled">
												<?php
												foreach($itens_galeria_duplex as $img){
													$imagem = wp_get_attachment_metadata( $img["img"], true );
													$upload_dir = wp_upload_dir();
													$path_img =  dirname($imagem["file"]);
													$url_img_xs = $upload_dir["baseurl"] . "/" . $path_img . "/" . $imagem["sizes"]["545x319"]["file"];
			...
			$tpt_infinity_galeria_plantas_duplex_show = get_field("tpt_infinity_galeria_plantas_duplex_show");
			$tpt_infinity_galeria_plantas_duplex_bgcolor = get_field("tpt_infinity_galeria_plantas_duplex_bgcolor");
			$tpt_infinity_galeria_plantas_duplex_titulo = get_field("tpt_infinity_galeria_plantas_duplex_titulo");
			$count = 0;
			if( have_rows('tpt_infinity_galeria_plantas_duplex_galeria') ):
				while ( have_rows('tpt_infinity_galeria_plantas_duplex_galeria') ) : the_row();
					$itens_galeria_plantas_duplex[$count]["img"] = get_sub_field("tpt_infinity_galeria_plantas_duplex_galeria_item_img");
					$itens_galeria_plantas_duplex[$count]["img_big"] = get_sub_field("tpt_infinity_galeria_plantas_duplex_galeria_item_img_big");
					$count ++;
				endwhile;
			endif;
			if ($tpt_infinity_galeria_plantas_duplex_show == 1){ ?>
				<div class="wrapper-geral wrapper-geral-infinity-apto-plantas" style="background-color:<?php echo $tpt_infinity_galeria_plantas_duplex_bgcolor; ?>;">
					<div class="container wrapper-inner-infinity-apto">

						<div class="row">
							<div class="col-12">
								<div class="section-content-header d-flex align-items-center flex-column">
									<h2 class="section-content-title text-center"><?php echo $tpt_infinity_galeria_plantas_duplex_titulo; ?></h2>
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col-12">
								<div class="row d-flex justify-content-center">
									<div class="col-12 col-md-10 col-lg-8 d-flex justify-content-center">
										<div class="image-gallery-box">
											<ul id="galeria-duplex-plantas" class="gallery list-unstyled">
												<?php
												foreach($itens_galeria_plantas_duplex as $img){
													$imagem = wp_get_attachment_metadata( $img["img"], true );
													$upload_dir = wp_upload_dir();
													$path_img =  dirname($imagem["file"]);
													$url_img_xs = $upload_dir["baseurl"] . "/" . $path_img . "/" . $imagem["sizes"]["545x319"]["file"];
