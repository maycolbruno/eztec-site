...
$count = 0;
if( have_rows('banners_produto_slider') ):
	while ( have_rows('banners_produto_slider') ) : the_row();
		$banners[$count]['titulo']    = get_sub_field("titulo_banner_slider");
		$banners[$count]['subtitulo'] = get_sub_field("subtitulo_banner_slider");
		$banners[$count]['status']    = get_sub_field("status_banner_slider");
		$banners[$count]['img']       = get_sub_field("img_banner_slider");
		$banners[$count]['img_md']       = get_sub_field("img_banner_slider_md");
		$banners[$count]['img_xs']       = get_sub_field("img_banner_slider_xs");
		$count ++;
	endwhile;
endif;
?>
