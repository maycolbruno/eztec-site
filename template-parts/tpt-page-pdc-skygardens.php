<?php
/*
 * Template Name: Parque da Cidade - Sky Gardens
...
?>
<div class="container-fluid wrapper-imovel pdc pdc-skygardens p-0">
	...
	<div id="primary" class="content-area">
		<main id="main" class="site-main">
						...
						<div class="wrapper-videopreview">
							<div class="video-preview-txt-container">
								<div class="wrap-titulo-banner-pdc">
									<h1 class="videopreview-titulo pdc-skygardens"><?php echo $tpt_pdc_banner_titulo; ?><div class="detalhe-titulo-pdc"></div></h1>
								</div>
			...
			<?php
			$tpt_pdc_skygardens_jardins_titulo = get_field("tpt_pdc_skygardens_jardins_titulo");
			$tpt_pdc_skygardens_jardins_chamada = get_field("tpt_pdc_skygardens_jardins_chamada");
			$tpt_pdc_skygardens_jardins_desc = get_field("tpt_pdc_skygardens_jardins_desc");
			$tpt_pdc_skygardens_jardins_citacao = get_field("tpt_pdc_skygardens_jardins_citacao");
			$tpt_pdc_skygardens_jardins_img548x685 = get_field("tpt_pdc_skygardens_jardins_img548x685");
			$tpt_pdc_skygardens_jardins_img375x288 = get_field("tpt_pdc_skygardens_jardins_img375x288");
			$tpt_pdc_skygardens_jardins_img2560x730 = get_field("tpt_pdc_skygardens_jardins_img2560x730");
			?>
							...
							<div class="sec-apresentacao-left col-xl-7 col-lg-7 col-12">
								<div class="wrap-apresentacao-left-txt">
									<div class="apresentacao-info">
										<h2 class="apresentacao-info-titulo"><?php echo $tpt_pdc_skygardens_jardins_titulo; ?></h2>
										<div class="apresentacao-divisor-pdc"></div>
										<p class="apresentacao-info-chamada"><?php echo $tpt_pdc_skygardens_jardins_chamada; ?></p>
										<p class="apresentacao-info-desc"><?php echo $tpt_pdc_skygardens_jardins_desc; ?></p>
									</div>
								</div>
								<div class="wrap-img-apresentacao-pdc">
									<img class="img-apresentacao-pdc img-fluid" src="<?php echo $tpt_pdc_skygardens_jardins_img375x288; ?>" alt="<?php echo $tpt_pdc_skygardens_jardins_titulo; ?>">
								</div>
							</div>
							<div class="sec-apresentacao-right col-xl-5 col-lg-5 col-12">
								<img class="img-citacao img-fluid" src="<?php echo $tpt_pdc_skygardens_jardins_img548x685; ?>" alt="<?php echo $tpt_pdc_skygardens_jardins_titulo; ?>">
								<div class="wrap-apresentacao-citacao">
									<p class="apresentacao-citacao"><?php echo $tpt_pdc_skygardens_jardins_citacao; ?></p>
								</div>
							</div>
						</div>
					</div>
			...
			<div class="wrapper-geral">
				<img class="img-extendida-pdc img-fluid" src="<?php echo $tpt_pdc_skygardens_jardins_img2560x730; ?>" alt="<?php echo $tpt_pdc_skygardens_jardins_titulo; ?>">
			</div>

			<?php 
			$tpt_pdc_skygardens_galeria_titulo = get_field("tpt_pdc_skygardens_galeria_titulo");
			$count = 0;
			if( have_rows('tpt_pdc_skygardens_galeria_itens') ):
				while ( have_rows('tpt_pdc_skygardens_galeria_itens') ) : the_row();
					$itens_galeria_gardens[$count]["img"] = get_sub_field("tpt_pdc_skygardens_galeria_item_img");
					$itens_galeria_gardens[$count]["img_big"] = get_sub_field("tpt_pdc_skygardens_galeria_item_img_big");
					$count ++;
				endwhile;
			endif;
			?>
					...
					<div class="row">
						<div class="col-12">
							<div class="section-content-header d-flex align-items-center flex-column">
								<h2 class="section-content-title text-center"><?php echo $tpt_pdc_skygardens_galeria_titulo; ?></h2>
							</div>
						</div>
					</div>
					<div class="row">
								...
								<div class="col-12 col-md-10 col-lg-8 d-flex justify-content-center">
									<div class="image-gallery-box">
										<ul id="galeria-apartamentos" class="gallery list-unstyled">
											<?php
											foreach($itens_galeria_gardens as $img){
