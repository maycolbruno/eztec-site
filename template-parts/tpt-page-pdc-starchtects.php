<?php
/*
 * Template Name: Parque da Cidade - Starchtects
...
?>
<div class="container-fluid wrapper-imovel pdc pdc-starchitects p-0">
	...
	<div id="primary" class="content-area">
		<main id="main" class="site-main">
						...
						<div class="wrapper-videopreview">
							<div class="video-preview-txt-container">
								<div class="wrap-titulo-banner-pdc">
									<h1 class="videopreview-titulo pdc-starchitects"><?php echo $tpt_pdc_banner_titulo; ?><div class="detalhe-titulo-pdc"></div></h1>
								</div>
			...
			<?php
			$tpt_pdc_starchitects_art_titulo = get_field("tpt_pdc_starchitects_art_titulo");
			$tpt_pdc_starchitects_art_chamada = get_field("tpt_pdc_starchitects_art_chamada");
			$tpt_pdc_starchitects_art_citacao = get_field("tpt_pdc_starchitects_art_citacao");
			$tpt_pdc_starchitects_art_desc = get_field("tpt_pdc_starchitects_art_desc");
			$tpt_pdc_starchitects_art_logo = get_field("tpt_pdc_starchitects_art_logo");
			$tpt_pdc_starchitects_art_img_725x600 = get_field("tpt_pdc_starchitects_art_img_725x600");
			$tpt_pdc_starchitects_art_img_787x375 = get_field("tpt_pdc_starchitects_art_img_787x375");
			$tpt_pdc_starchitects_art_img_300x300 = get_field("tpt_pdc_starchitects_art_img_300x300");
			?>
			<div class="wrapper-geral wrapper-geral-starchitects">
				<div class="wrapper-inner-starchitects-art">
					<div class="container-starchitects-art container-fluid">
						<div class="row">
							<div class="wrap-art-img-topo col-xl-6 col-lg-6 col-12">
								<img class="art-img-topo img-fluid" src="<?php echo $tpt_pdc_starchitects_art_img_725x600; ?>">
							</div>
							<div class="wrap-art-txt col-xl-4 col-lg-4 col-12">
								<div class="art-txt">
									<h2 class="apresentacao-info-titulo"><?php echo $tpt_pdc_starchitects_art_titulo; ?></h2>
									<div class="apresentacao-divisor-pdc"></div>
									<p class="apresentacao-info-chamada"><?php echo $tpt_pdc_starchitects_art_chamada; ?></p>
									<p class="apresentacao-info-desc"><?php echo $tpt_pdc_starchitects_art_desc; ?></p>
								</div>
							</div>
							<div class="wrap-art-logo-uns col-xl-2 col-lg-2 col-12">
								<img class="art-logo-uns" src="<?php echo $tpt_pdc_starchitects_art_logo; ?>">
							</div>
						</div>
						<div class="row row-imgs-art">
							<div class="wrap-art-citacao col-xl-6 col-lg-6 col-12">
								<div class="citacao-box-art d-flex align-items-center">
									<p class="citacao-art"><?php echo $tpt_pdc_starchitects_art_citacao; ?></p>
									<img src="<?php echo $tpt_pdc_starchitects_art_img_300x300; ?>">
								</div>
							</div>
							<div class="wrap-art-img col-xl-6 col-lg-6 col-12">
								<img src="<?php echo $tpt_pdc_starchitects_art_img_787x375; ?>">
							</div>
						</div>
					</div>
				</div>
			...
			<?php
			$tpt_pdc_starchitects_paisagistico_titulo = get_field("tpt_pdc_starchitects_paisagistico_titulo");
			$tpt_pdc_starchitects_paisagistico_desc = get_field("tpt_pdc_starchitects_paisagistico_desc");
			$tpt_pdc_starchitects_paisagistico_img = get_field("tpt_pdc_starchitects_paisagistico_img");
			$tpt_pdc_starchitects_paisagistico_logo = get_field("tpt_pdc_starchitects_paisagistico_logo");

			$tpt_pdc_starchitects_interiores_titulo = get_field("tpt_pdc_starchitects_interiores_titulo");
			$tpt_pdc_starchitects_interiores_desc = get_field("tpt_pdc_starchitects_interiores_desc");
			$tpt_pdc_starchitects_interiores_img = get_field("tpt_pdc_starchitects_interiores_img");
			$tpt_pdc_starchitects_interiores_logo = get_field("tpt_pdc_starchitects_interiores_logo");
			?>
			<div class="wrapper-geral wrapper-geral-paisagistico-interiores">
				<div class="wrapper-inner-starchitects-paisagistico-interiores">
					<div class="container-interiores container-fluid">
						<div class="row">
							<div class="item-interiores col-xl-6 col-lg-6 col-12">
								<img class="imagem-interiores" src="<?php echo $tpt_pdc_starchitects_paisagistico_img; ?>">
								<h2 class="apresentacao-info-titulo"><?php echo $tpt_pdc_starchitects_paisagistico_titulo; ?></h2>
								<div class="apresentacao-divisor-pdc"></div>
								<p class="apresentacao-info-desc"><?php echo $tpt_pdc_starchitects_paisagistico_desc; ?></p>
								<div class="wrap-logo-interiores">
									<img src="<?php echo $tpt_pdc_starchitects_paisagistico_logo; ?>">
								</div>
							</div>
							<div class="item-interiores col-xl-6 col-lg-6 col-12">
								<img class="imagem-interiores" src="<?php echo $tpt_pdc_starchitects_interiores_img; ?>">
								<h2 class="apresentacao-info-titulo"><?php echo $tpt_pdc_starchitects_interiores_titulo; ?></h2>
								<div class="apresentacao-divisor-pdc"></div>
								<p class="apresentacao-info-desc"><?php echo $tpt_pdc_starchitects_interiores_desc; ?></p>
								<div class="wrap-logo-interiores">
									<img src="<?php echo $tpt_pdc_starchitects_interiores_logo; ?>">
								</div>
							</div>
						</div>
					</div>
