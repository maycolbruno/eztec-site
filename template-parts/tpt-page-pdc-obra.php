<?php
/*
 * Template Name: Parque da Cidade - Obra
...
?>
<div class="container-fluid wrapper-imovel pdc pdc-obra p-0">
	...
	<div id="primary" class="content-area">
		<main id="main" class="site-main">
						...
						<div class="wrapper-videopreview">
							<div class="video-preview-txt-container">
								<div class="wrap-titulo-banner-pdc">
									<h1 class="videopreview-titulo pdc-obra"><?php echo $tpt_pdc_banner_titulo; ?><div class="detalhe-titulo-pdc"></div></h1>
								</div>
			...
			<div class="wrapper-geral wrapper-geral-pdc-obra">
				<div class="wrapper-inner wrapper-inner-pdc-obra">
