<?php
/*
 * Template Name: EZ Infinity - Serviços
...
?>
<div class="container-fluid wrapper-imovel infinity infinity-servicos p-0">
	...
	<div id="primary" class="content-area">
		<main id="main" class="site-main">
						...
						<div class="wrapper-videopreview">
							<div class="video-preview-txt-container">
								<div class="wrap-titulo-banner-infinity">
									<h1 class="videopreview-titulo infinity-servicos"><?php echo $tpt_infinity_banner_titulo; ?><div class="detalhe-titulo-infinity"></div></h1>
								</div>
			...
			<?php
			$tpt_infinity_servicos_zservices_titulo = get_field("tpt_infinity_servicos_zservices_titulo");
			$tpt_infinity_servicos_zservices_chamada = get_field("tpt_infinity_servicos_zservices_chamada");
			$tpt_infinity_servicos_zservices_desc = get_field("tpt_infinity_servicos_zservices_desc");
			$tpt_infinity_servicos_zservices_img_548x685 = get_field("tpt_infinity_servicos_zservices_img_548x685");
			$tpt_infinity_servicos_zservices_img_417x478 = get_field("tpt_infinity_servicos_zservices_img_417x478");
			$tpt_infinity_servicos_zservices_img_1018x559 = get_field("tpt_infinity_servicos_zservices_img_1018x559");
			$tpt_infinity_servicos_zservices_bgimg = get_field("tpt_infinity_servicos_zservices_bgimg");
			$tpt_infinity_servicos_zservices_logo = get_field("tpt_infinity_servicos_zservices_logo");
			$tpt_infinity_servicos_zservices_desc_list = get_field("tpt_infinity_servicos_zservices_desc_list");
			$tpt_infinity_servicos_zservices_txt_legal = get_field("tpt_infinity_servicos_zservices_txt_legal");
			?>
						...
						<div class="row">
							...
							<div class="z-services-apresentacao col-xl-3 col-lg-4 col-12">
								<div class="wrapper-zservices-info">
									<h2 class="apresentacao-info-titulo"><?php echo $tpt_infinity_servicos_zservices_titulo; ?></h2>
									<div class="apresentacao-divisor-infinity"></div>
									<p class="apresentacao-info-chamada"><?php echo $tpt_infinity_servicos_zservices_chamada; ?></p>
									<p class="apresentacao-info-desc"><?php echo $tpt_infinity_servicos_zservices_desc; ?></p>
								</div>
							</div>
							<div class="z-services-imgs-topo1 col-xl-3 col-lg-3 col-12">
								<img class="zservices-img-topo1 img-fluid" src="<?php echo $tpt_infinity_servicos_zservices_img_548x685; ?>">
							</div>
						</div>
						<div class="row">
							<div class="z-services-imgs col-xl-4 col-lg-4 col-12">
								<img class="zservices-img1" src="<?php echo $tpt_infinity_servicos_zservices_img_417x478; ?>">
							</div>
							<div class="z-services-imgs col-xl-8 col-lg-8 col-12">
								<img class="zservices-img2" src="<?php echo $tpt_infinity_servicos_zservices_img_1018x559; ?>">
							</div>
						</div>
					</div>
				</div>
					...
					<div class="container-servicos-list container-fluid">
						<div class="row">
							<div class="wrap-logo-zservices col-xl-2 col-lg-2 col-12">
								<img src="<?php echo $tpt_infinity_servicos_zservices_logo; ?>" class="logo-zservices">
							</div>
							<div class="wrap-list-zservices col-xl-10 col-lg-10 col-12">
								<p class="list-zservices"><?php echo $tpt_infinity_servicos_zservices_desc_list; ?></p>
								<div class="wrapper-inner-txt-legal-servicos">
									<p class="txt-legal-servicos"><?php echo $tpt_infinity_servicos_zservices_txt_legal; ?></p>
								</div>
							</div>
						</div>
					</div>
