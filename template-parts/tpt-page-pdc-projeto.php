<?php
/*
 * Template Name: Parque da Cidade - Projeto
...
?>
<div class="container-fluid wrapper-imovel pdc pdc-projeto p-0">
	...
	<div id="primary" class="content-area">
		<main id="main" class="site-main">
						...
						<div class="wrapper-videopreview">
							<div class="video-preview-txt-container">
								<div class="wrap-titulo-banner-pdc">
									<h1 class="videopreview-titulo pdc-projeto"><?php echo $tpt_pdc_banner_titulo; ?><div class="detalhe-titulo-pdc"></div></h1>
								</div>
			...
			<?php
			$tpt_pdc_projeto_design_titulo = get_field("tpt_pdc_projeto_design_titulo");
			$tpt_pdc_projeto_design_chamada = get_field("tpt_pdc_projeto_design_chamada");
			$tpt_pdc_projeto_design_desc = get_field("tpt_pdc_projeto_design_desc");
			$tpt_pdc_projeto_design_desc_unstudio = get_field("tpt_pdc_projeto_design_desc_unstudio");
			$tpt_pdc_projeto_design_txt_unstudio = get_field("tpt_pdc_projeto_design_txt_unstudio");
			$tpt_pdc_projeto_design_box = get_field("tpt_pdc_projeto_design_box");
			$tpt_pdc_projeto_design_ficha_cta = get_field("tpt_pdc_projeto_design_ficha_cta");
			$tpt_pdc_projeto_design_ficha_cta_img = get_field("tpt_pdc_projeto_design_ficha_cta_img");
			$tpt_pdc_projeto_design_ficha_txt = get_field("tpt_pdc_projeto_design_ficha_txt");
			$tpt_pdc_projeto_design_img1080x600 = get_field("tpt_pdc_projeto_design_img1080x600");
			$tpt_pdc_projeto_design_img787x375 = get_field("tpt_pdc_projeto_design_img787x375");
			$tpt_pdc_projeto_design_img300x300 = get_field("tpt_pdc_projeto_design_img300x300");
			?>
					...
					<div class="container-fluid container-projeto-design-topo p-0">
						<div class="row p-0">
							<div class="wrap-projeto-design-topo-img col-xl-6 col-lg-6 col-12">
								<img class="projeto-design-topo-img" src="<?php echo $tpt_pdc_projeto_design_img1080x600; ?>" alt="<?php echo $tpt_pdc_projeto_design_titulo; ?>">
							</div>
							<div class="wrap-projeto-design-topo-info col-xl-6 col-lg-6 col-12">
								<div class="projeto-design-topo-info">
									<h2 class="apresentacao-info-titulo"><?php echo $tpt_pdc_projeto_design_titulo; ?></h2>
									<div class="apresentacao-divisor-pdc"></div>
									<p class="apresentacao-info-chamada"><?php echo $tpt_pdc_projeto_design_chamada; ?></p>
									<p class="apresentacao-info-desc"><?php echo $tpt_pdc_projeto_design_desc; ?></p>
								</div>
							</div>
						</div>
					</div>
							...
							<div class="row p-0">
								<div class="wrap-projeto-design-bloco-2-info col-xl-6 col-lg-6 col-12">
									<div class="projeto-design-bloco-2-info-txt d-flex align-items-center">
										<div class="projeto-design-txt">
											<p class="unstudio-txt"><?php echo $tpt_pdc_projeto_design_desc_unstudio; ?></p>
											<p class="unstudio-txt-legal"><?php echo $tpt_pdc_projeto_design_txt_unstudio; ?></p>
										</div>
										<img src="<?php echo $tpt_pdc_projeto_design_img300x300; ?>">
									</div>
									<div class="wrap-cta-design">
										<a class="btn-cta-pdc" style="background-image:url(<?php echo $tpt_pdc_projeto_design_ficha_cta_img; ?>);" data-toggle="collapse" href="#collapseExample" role="button" aria-expanded="false" aria-controls="collapseExample">
											<?php echo $tpt_pdc_projeto_design_ficha_cta; ?>
										</a>
									</div>
									<div class="collapse" id="collapseExample">
									  <div class="card card-body">
									    <?php echo $tpt_pdc_projeto_design_ficha_txt; ?>
									  </div>
									</div>
								</div>
								<div class="wrap-projeto-design-bloco-2-img col-xl-6 col-lg-6 col-12">
									<img class="projeto-design-bloco-2-img" src="<?php echo $tpt_pdc_projeto_design_img787x375; ?>" alt="<?php echo $tpt_pdc_projeto_design_titulo; ?>">
									<div class="wrapper-box-produto-pdc-aptos">
										<?php echo $tpt_pdc_projeto_design_box; ?>
									</div>
								</div>
							</div>
						</div>
			...
			<?php
			$tpt_pdc_projeto_diferenciais_titulo = get_field("tpt_pdc_projeto_diferenciais_titulo");
			$tpt_pdc_projeto_diferenciais_chamada = get_field("tpt_pdc_projeto_diferenciais_chamada");
			$count = 0;
			if( have_rows('tpt_pdc_projeto_diferenciais_itens') ):
				while ( have_rows('tpt_pdc_projeto_diferenciais_itens') ) : the_row();
					$itens_diferenciais[$count]["titulo"] = get_sub_field("tpt_pdc_projeto_diferenciais_item_titulo");
					$itens_diferenciais[$count]["icon"] = get_sub_field("tpt_pdc_projeto_diferenciais_item_icon");
					$itens_diferenciais[$count]["desc"] = get_sub_field("tpt_pdc_projeto_diferenciais_item_desc");
					$count ++;
				endwhile;
			endif;
			$tpt_pdc_projeto_diferenciais_txt_legal = get_field("tpt_pdc_projeto_diferenciais_txt_legal");
			$tpt_pdc_projeto_diferenciais_selo_icon = get_field("tpt_pdc_projeto_diferenciais_selo_icon");
			$tpt_pdc_projeto_diferenciais_selo_titulo = get_field("tpt_pdc_projeto_diferenciais_selo_titulo");
			$tpt_pdc_projeto_diferenciais_selo_desc = get_field("tpt_pdc_projeto_diferenciais_selo_desc");
			?>
					...
					<div class="container-projeto-diferenciais container-fluid p-0">
						<div class="row p-0">
							<div class="titulo-header-projeto-diferenciais col-12">
								<div class="wrap-titulo-header-projeto-diferenciais">
									<h2 class="apresentacao-info-titulo"><?php echo $tpt_pdc_projeto_diferenciais_titulo; ?></h2>
									<div class="apresentacao-divisor-pdc"></div>
									<p class="apresentacao-info-chamada"><?php echo $tpt_pdc_projeto_diferenciais_chamada; ?></p>
								</div>
							</div>
						</div>
						<div class="row p-0">
							...
							foreach ($itens_diferenciais as $i){
								echo '
								<div class="pdc-projeto-item-dif-icon col-xl-1 col-lg-1 col-12">
									<img src="' . $i["icon"] . '" alt ="' . $i["titulo"] . '">
								</div>
								<div class="pdc-projeto-item-dif-txt col-xl-11 col-lg-11 col-12">
						...
						<div class="row p-0">
							<div class="dif-txt-legal col-12">
								<p><?php echo $tpt_pdc_projeto_diferenciais_txt_legal; ?></p>
							</div>
						</div>
					</div>
				</div>
				<hr class="separador-dif-selo">
				<div class="wrapper-inner-projeto-diferenciais">
					<div class="container-projeto-selo container-fluid p-0">
						<div class="row p-0">
							<div class="selo-img col-xl-2 col-lg-2 col-12">
								<img src="<?php echo $tpt_pdc_projeto_diferenciais_selo_icon; ?>" alt="<?php echo $tpt_pdc_projeto_diferenciais_selo_titulo; ?>">
							</div>
							<div class="selo-img col-xl-10 col-lg-10 col-12">
								<p class="titulo-dif"><?php echo $tpt_pdc_projeto_diferenciais_selo_titulo; ?></p>
								<p class="desc-dif"><?php echo $tpt_pdc_projeto_diferenciais_selo_desc; ?></p>
							</div>
						</div>
					</div>
				</div>
			...
			<?php
			$tpt_pdc_projeto_paisagismo_titulo = get_field("tpt_pdc_projeto_paisagismo_titulo");
			$tpt_pdc_projeto_paisagismo_chamada = get_field("tpt_pdc_projeto_paisagismo_chamada");
			$tpt_pdc_projeto_paisagismo_desc = get_field("tpt_pdc_projeto_paisagismo_desc");
			$tpt_pdc_projeto_paisagismo_img1590x670 = get_field("tpt_pdc_projeto_paisagismo_img1590x670");
			$tpt_pdc_projeto_paisagismo_img548x685 = get_field("tpt_pdc_projeto_paisagismo_img548x685");
			?>
			<div class="wrapper-geral wrapper-geral-projeto">
				<div class="wrapper-inner-projeto-paisagismo">
					<div class="container-projeto-paisagismo container-fluid">
						<div class="row">
							<div class="wrap-projeto-paisagismo-img-topo col-12">
								<img class="projeto-paisagismo-img-topo img-fluid" src="<?php echo $tpt_pdc_projeto_paisagismo_img1590x670; ?>" alt="<?php echo $tpt_pdc_projeto_paisagismo_titulo; ?>">
							</div>
							<div class="wrap-projeto-paisagismo-img col-xl-4 col-lg-4 col-12">
								<img class="projeto-paisagismo-img img-fluid" src="<?php echo $tpt_pdc_projeto_paisagismo_img548x685; ?>" alt="<?php echo $tpt_pdc_projeto_paisagismo_titulo; ?>">
							</div>
							<div class="wrap-projeto-paisagismo-txt col-xl-8 col-lg-8 col-12">
								<div class="wrapper-projeto-paisagismo-info">
									<h2 class="apresentacao-info-titulo"><?php echo $tpt_pdc_projeto_paisagismo_titulo; ?></h2>
									<div class="apresentacao-divisor-pdc"></div>
									<p class="apresentacao-info-chamada"><?php echo $tpt_pdc_projeto_paisagismo_chamada; ?></p>
									<p class="apresentacao-info-desc"><?php echo $tpt_pdc_projeto_paisagismo_desc; ?></p>
								</div>
							</div>
						</div>
					</div>
